...
public class AjouterPressionDiastoliqueCibleDialog extends AppCompatDialogFragment {
    private EditText modiPoidsCible;
    private AjouterPressionDiastoliqueCibleDialogListner listner;
    ...
    public interface AjouterPressionDiastoliqueCibleDialogListner {
        void applyNvPressionDiastoliqueCible(Float tensionCible);
    }
}