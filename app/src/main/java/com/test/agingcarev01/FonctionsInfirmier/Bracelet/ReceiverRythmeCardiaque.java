...
public class ReceiverRythmeCardiaque extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_receiver_rythme_cardiaque);
                                ...
                                for (int i = 0; i < bytesAvailable; i++) {
                                    ...
                                    if (b == delimiter) { // If found a # print on screen
                                        ...
                                        handler.post(new Runnable() {
                                            public void run() {
                                                dataTW.setText(data + " BPM"); // Print on screen
                                            }
                                        });
    ...
    private class ConnectBT extends AsyncTask<Void, Void, Void> { // UI thread
        ...
        protected void onPreExecute() {
            progress = ProgressDialog.show(ReceiverRythmeCardiaque.this, "Connection ...", "S'il vous plaît, Attendez!"); // Connection loading dialog
        }
